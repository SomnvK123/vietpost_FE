    ...
    return (
        <footer className="footer">
            <div className="container">
                <div className="row">
                    <div className="col-12 col-sm-8 offset-sm-2 col-md-3 offset-md-0">
                        <div className="intro">
                    ...
                    <div className="col-12 col-sm-8 offset-sm-2 col-md-3 offset-md-0">
                        <div claclassNamess="heading">Về chúng tôi</div>
                        <ul className="list-unstyled links-list">
                            <li>
                                <a claclassNamess="gf-link" href="https://zalo.me/g/zaqhuu493">
                                    <img src="https://vietpost.com.au/_next/static/right-angle-c4b7d5566fb4b356822df3dd87556b1f.svg"
                                        alt="" />
                    ...
                    <div claclassNamess="col-12 col-sm-8 offset-sm-2 col-md-3 offset-md-0">
                ...
                <div className="col-12 col-sm-8 offset-sm-2 col-md-3 offset-md-9 share">
