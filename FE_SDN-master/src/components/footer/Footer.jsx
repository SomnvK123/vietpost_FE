        ...
        <footer class="footer">
            <div class="container">
                <div class="row">
                    <div class="col-12 col-sm-8 offset-sm-2 col-md-3 offset-md-0">
                        <div class="intro">
                            <img src="https://vietpost.com.au/_next/static/logo-header-d003d2174319c9c12a4071ecb632a963.svg"
                                alt="" />
                            <div class="desc">Vietpost là dịch vụ Thương mại điện tử &amp;Logistic của Vpost. Đây là
                    ...
                    <div class="col-12 col-sm-8 offset-sm-2 col-md-3 offset-md-0">
                        <div class="heading">An Inch Aways</div>
                        <div class="address">
                            <p>
                ...
                <div class="col-12 col-sm-8 offset-sm-2 col-md-3 offset-md-9 share">
