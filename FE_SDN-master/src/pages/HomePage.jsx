                                                        ...
                                                        <div class="send-process-item px-3 pb-3">
                                                            ...
                                                            <div class="mt-3">
                                                                <div class="html-content ql-editor html-content--block">
                                                                    <p>
                                                                        <span style={{ color: 'rgb(33, 37, 41)', fontSize: '14px' }}>Quý khách cần đăng ký một tài khoản online trên website trước khi thực hiện tạo vận đơn</span>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="bg-white flex-grow-1 flex-shrink-1">
                                                        ...
                                                        <div class="send-process-item px-3 pb-3">
                                                            ...
                                                            <div class="mt-3">
                                                                <div class="html-content ql-editor html-content--block">
                                                                    <p>
                                                                        <span style={{ fontSize: '14px', color: 'rgb(33, 37, 41)' }}>Sau khi mở tài khoản online thành công, Quý khách cần</span>
                                                                        <a href="https://vp2-web.faskera.com/auth/login"
                                                                            rel="noopener noreferrer"
                                                                            target="_blank"
                                                                            style={{ fontSize: '14px', color: 'rgb(33, 37, 41)' }}>
                                                                            <strong>ĐĂNG NHẬP (Login)</strong> v
                                                                        </a>
                                                                        <span style={{ fontSize: '14px', color: 'rgb(33, 37, 41)' }}>Đã tạo tài khoản của bạn rồi thực hiện khai báo gửi hàng (thông tin người gửi, thông tin người nhận, danh sách hàng gửi, thông tin về kiện hàng gửi, ...) theo mẫu form đã được cung cấp.</span>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="bg-white flex-grow-1 flex-shrink-1">
                                                        ...
                                                        <div class="send-process-item px-3 pb-3">
                                                            ...
                                                            <div class="mt-3">
                                                                <div class="html-content ql-editor html-content--block">
                                                                    <p>
                                                                        <span style={{ fontSize: '14px', color: 'rgb(33, 37, 41)' }}>Quý khách sẽ nhận được 01 thông báo gửi hàng từ công ty qua email. Nếu không có thắc mắc gì về vận đơn thì bạn thực hiện thanh toán tiền vận chuyển qua hình thức chuyển khoản hoặc Quý khách có thể trả tiền mặt ở nơi gửi/Pick hàng (Nếu địa chỉ gửi hàng của bạn nằm trong khu vực hỗ trợ pick hàng hoặc có đại lý thu gom của Vietpost)</span>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="bg-white flex-grow-1 flex-shrink-1">
                                                        ...
                                                        <div class="send-process-item px-3 pb-3">
                                                            ...
                                                            <div class="mt-3">
                                                                <div class="html-content ql-editor html-content--block">
                                                                    <p>
                                                                        <span style={{ fontSize: '14px', color: 'rgb(33, 37, 41)' }}>Hàng hóa cần được đóng gói cẩn thận trước khi đem đi gửi đến điểm gom hàng/Kho Sydney của Vietpost hoặc giao cho nhân viên pick hàng tại địa điểm gửi hàng của quý khách. Vui lòng tham khảo quy cách đóng gói của Vietpost.</span>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                            <div class="mt-3 text-center">
                                                    ...
                                                    <div class="bg-white flex-grow-1 flex-shrink-1">
                                                        ...
                                                        <div class="send-process-item px-3 pb-3">
                                                            ...
                                                            <div class="mt-3">
                                                                <div class="html-content ql-editor html-content--block">
                                                                    <p>
                                                                        <span style={{ fontSize: '14px', color: 'rgb(33, 37, 41)' }}>Hàng sẽ được giao cho người nhận từ 7 – 10 ngày làm việc (tùy theo vị trí địa lý) kể từ ngày hàng lên máy bay rời khỏi Úc. Quý khách có thể theo dõi kiện hàng của mình trực tiếp trên website của công ty. Hệ thống sẽ tự động cập nhật thông tin đến email của quý khách về các trạng thái, lịch trình của vận đơn.</span>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
